...
## 7.0 Submittal Instructions and Evaluation

### 7.1	Instructions for Quotes

#### Questions

All questions concerning this RFQ must be submitted electronically through this Google Form by the deadline provided above. (to be provided at time of final RFQ release)
...
*Note - this is the process we will use for questions on the final RFQ. For the draft RFQ, please follow the instructions included in Github.

### 7.2 Evaluation Criteria and Quote Submittal Instructions 
...
**Criteria 1:** a technical approach and Performance Work Statement of no more than six pages, 
...
Technical submissions may also include user research plans and design artifacts.
...
##### Criteria 1 - Technical Approach and Performance Work Statement
...
Vendors shall provide a Performance Work Statement (PWS), in addition to the response to Criteria 1 - Technical Approach . The deliverables under this PWS shall have functionality scheduled for an available release without defects.
 
The PWS shall clearly illustrate the Agile Development process for software in small iterations lasting two to five weeks, which results in usable software as described the SOO. 

Vendors shall propose a “Definition of Done” that will apply to all User Stories and demonstrate the validation necessary to complete an iteration.
 
The PWS shall describe how user stories will be sized, how estimation and determination of sizes shall be accomplished, and how these will correlate to iterations and throughput.

Additionally, the PWS shall provide a detailed process for working with the Product  Owner and End Users to capture user stories, prioritize, and work-off the product backlog. The prioritization effort may include working backlog items across multiple projects concurrently based on team capacity and end user priorities.
 
In the PWS, vendors shall demonstrate how the applications, databases, and other products will meet the requirements for compliance as outlined in the QASP, Section 508 of the Rehabilitation Act (See 16.1), and GSA’s IT Security Requirements.
...
The staffing plan must set forth and explain the extent to which the contractor will provide individuals with experience in most of the following areas:
...
### 7.3 Basis of Award and Evaluation Factors
...
**_NOTE: The government anticipates selecting an awardee based upon initial quotes received; therefore, contractors are cautioned to submit their best price and technical quotes in the initial submission._**
